...
- Check if they occur monthly (±3 days)
...
- ✅ Total household budget (all spending combined)
- ✅ Category-specific budgets
- ✅ Visual progress bars with color coding
- ✅ Configurable alert thresholds (default 80%)
- ✅ Red/amber color when approaching or exceeding limits
...
- ✅ Search by merchant name and description (debounced)
- ✅ Date range filter (This Month, Last Month, Last 3/6 Months, This Year, Custom)
...
**Status:** ✅ Completed (Multiple Issues)
**Completed:** December 2025
...
- ✅ Monthly settlement toggle
- ✅ Push notification settings (granular preferences)
- ✅ Budget management
- ✅ Category management (Issue #31)
...
- ✅ Date range selection (This Month, Last Month, Last 3 Months, Custom)
- ✅ Transaction type filter (All, Joint Only, Personal Only)
- ✅ CSV download with proper filename format
- ✅ CSV columns: Date, Merchant, Category, Amount, Type, Added By, Notes
...
## 8. "Hide from Partner" Toggle (DOCUMENTED FROM ISSUE #9 REVIEW)
...
**Database:** Already has `is_hidden` column ✅
...
4. Partner sees: "-$100 [Private Transaction] 🔒 - Personal"

---

## 9. Single-Use Invite Codes (DOCUMENTED FROM ISSUE #9 REVIEW)
...
## 10. Robust Plaid Error Handling (Deferred from #21)
...
- ✅ Basic error handling (try/catch with user messages)
- ✅ Loading states during linking and syncing
- ✅ Last synced timestamp display
- ✅ Unlink account functionality

---

## 11. Cursor-Based Transaction Sync (Optimization)
...
## 12. Advanced Filtering Enhancements (Future)

**Status:** Not Started  
**Estimated Time:** 4-6 hours total  
**Dependencies:** Issue #30 (Transaction Filtering) ✅  
...
1. ~~**Transaction History/Filtering**~~ ✅ Completed (Issue #30)
2. ~~**Budget Progress Bars**~~ ✅ Completed (Issue #27)
3. ~~**Household Settings Page**~~ ✅ Completed (Multiple Issues)
4. ~~**Export to CSV**~~ ✅ Completed (Issue #32)
5. **Spending Trends Chart** (Visual appeal for demos)
6. **Hide from Partner Toggle** (Nice to have for privacy)
7. **Single-Use Invite Codes** (Security improvement)
8. **Robust Plaid Error Handling** (Reliability improvement)
9. **Recurring Bill Detective** (Lower priority, can be V2.0)
10. **Cursor-Based Transaction Sync** (Optimization, low priority)
11. **Goal Auto-Sync** (Complex, can be V2.0)
12. **Advanced Filtering Enhancements** (V2.0 polish)
